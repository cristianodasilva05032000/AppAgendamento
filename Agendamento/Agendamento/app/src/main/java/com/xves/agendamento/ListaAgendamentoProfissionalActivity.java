...
public class ListaAgendamentoProfissionalActivity extends AppCompatActivity {

    BaseDados database;
    RecyclerView recyclerView;
    ConsultaServicoProfissionalAdapter recycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler = new ConsultaServicoProfissionalAdapter(datamodel, this);
    ...
    public List<ServiceModel> getServicos() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM xves_service            " +
                                        " WHERE id_profissional = ?", new String[]{id_user});
